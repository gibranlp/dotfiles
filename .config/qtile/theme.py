    ...
    widgets_list = [
           widget.TextBox(
            ...
            widget.CurrentLayout(
              decorations=[BorderDecoration(colour=comp_color[1], border_width=2)],
              padding=5,
              background=color[1],
              foreground=comp_color[1],
              scale=0.8,
            ),
            widget.TextBox(
              foreground=color[2],
            ...
            widget.CPU(
              foreground=comp_color[2],
              background=color[2],
              format='{load_percent}%',
              decorations=[BorderDecoration(colour=comp_color[2], border_width=2)],
              padding=5,
            ),
            widget.TextBox(
              foreground=color[3],
            ...
            widget.Memory(
              decorations=[BorderDecoration(colour=comp_color[3], border_width=2)],
              background=color[3],
              foreground=comp_color[3],
